...
include('../../connect.php');
if(isset($_REQUEST['cpsubmit'])){
$cptext=mysql_real_escape_string(stripslashes($_POST['cptext']));
mysql_query("update innerpages set cprofile='$cptext' where id=1");
}
...
<html>
	<head>
		<title>Jamibikroy.com | Admin | Company Profile</title>
		<style type="text/css">
			.logout{
				color:white;
							...
							<td align="center" valign="top">
								...
								<form action="" method="post">
									<table border="0px" width="100%" style="border-collapse:collapse;font-family:tahoma;font-size:11px">
										<tr height="25px">
											<td><textarea id="area2" name="cptext" style="width:100%;height:400px;"><?php echo "$row[cprofile]";?></textarea></td>
										</tr>
										<tr height="25px">
											<td align="right"><input type="submit" value="Save" name="cpsubmit" style="width:100px;height:25px"></td>
										</tr>
									</table>
								</form>
								<!----------------------------------Pending Ads End ------------------------------------->
