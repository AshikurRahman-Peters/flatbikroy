...
if(isset($_REQUEST['fileno'])){
	$fileno="$_GET[fileno]";
	$result=mysql_query("select * from published where adid=$fileno");
}
...
<html>
	<head>
		...
		<script>
			function SearchByFileId(){
				var fileid = document.getElementsByName('txtfileid')[0].value;
				window.location.href="?fileno="+fileid;
			}
		</script>
			...
			<tr>
				...
				<td align="left" valign="top">
					...
					<table border="0px" width="100%" style="border-collapse:collapse;">
						...
						<tr height="30px">
							<td align="left">
								<table border="0px" width="100%" height="30px" style="border-collapse:collapse;font-family:tahoma;font-size:13px">
									<tr>
										<td>
											File No: <input type="text" name="txtfileid" style="width:150px;height:25px">
											<input type="button" name="btnsrchfileid" value="Search" onclick="SearchByFileId()" style="width:70px;height:25px">
										</td>
										<td align="right">
