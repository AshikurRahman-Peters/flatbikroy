...
$result=mysql_query("select * from products where adid='$adid'");
...
<html>
	<head>
		<title>Jamibikroy.com | Admin | Pending Ads | View</title>
					...
					<table border="0px" width="100%" style="border-collapse:collapse;">
						...
						<tr height="500px">
							<td align="center" valign="top">
								<!---------------------------------- Ad Details ----------------------------------------->
								<form name="detailform" action="publish" method="get">
									...
									<tr height="40px">
										<td colspan="4">
											<table border="0px" width="100%" style="border-collapse:collapse;border-bottom:1px solid gray">
												<tr>
													<td></td>
													<td id="pbicn" width="50px" align="center" style="font-size:11px;cursor:pointer" onmouseover="tdhover('pbicn')" onmouseout="tdout('pbicn')" onclick="detailform.submit()"><img height="28px" src="../../../images/publishicon.png"><br>Publish</td>
