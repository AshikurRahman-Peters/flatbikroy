	...
	<head>
		...
		<script>
			function SendFeedback(){
				var fbfname= document.getElementsByName('fbfname')[0].value;
				var fbfphone= document.getElementsByName('fbfphone')[0].value;
				var fbfemail= document.getElementsByName('fbfemail')[0].value;
				var fbfsubject= document.getElementsByName('fbfsubject')[0].value;
				var fbfmessage= document.getElementsByName('fbfmessage')[0].value;
				...
				if(fbfname == "" || fbfphone == "" || fbfemail == "" || fbfsubject == "" || fbfmessage == ""){
					...
					if (atpos<1 || dotpos<atpos+2 || dotpos+2>=x.length)
					{
						...
						xmlhttp.open("POST", "sendfbf.php", true);
						xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
						xmlhttp.send("fbfname="+fbfname+"&&fbfphone="+fbfphone+"&&fbfemail="+fbfemail+"&&fbfsubject="+fbfsubject+"&&fbfmessage="+fbfmessage);

						alert("Thank You!! Your Feedback has been sent");
						document.getElementsByName('fbfname')[0].value = '';
						document.getElementsByName('fbfphone')[0].value = '';
						document.getElementsByName('fbfemail')[0].value = '';
						document.getElementsByName('fbfsubject')[0].value = '';
						document.getElementsByName('fbfmessage')[0].value = '';
					}
				}
			}
		</script>
										...
										<td width="355px">
											...
											<table border="0px" width="350px" style="border-collapse:collapse;font-family:tahoma;font-size:13px">
												...
												<tr>
													<td></td>
													<td></td>
													<td align="left" valign="middle"><input type="button" name="fbfsubmit" value="Send Message" onclick="SendFeedback()" style="width:150px;height:25px"></td>
												</tr>
