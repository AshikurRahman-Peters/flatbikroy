<?php
	...
	mysql_query("insert into products (date, ipaddress) values ('$date', '$ipaddress')");
	$result=mysql_query("select MAX(adid) as maxadid from products");
...
<html>
	<head>
		<title>Jamibikroy.com | New Ad</title>
					...
					<table border="0px" width="920px" style="margin:30 0;border-collapse:collapse;background:white;">
						...
						<tr>
							<td id="adformcontainer" colspan="5" valign="top" align="center"><br><br>
								...
								<input type="hidden" name="adid" value="<?php echo $maxadid;?>">
								<table border="0px" width="800px" style="border-collapse:collapse;">
									...
									<tr style="font-family:tahoma;font-size:13px">
										...
										<td width="10px"></td>
										<td><input type="text" name="txtadtitle" style="width:250px;height:27px;" maxlength="100" onKeyUp="FldTextValidation(this, 'titleerrtxt')"></td>
									</tr>
									...
									<tr style="font-family:tahoma;font-size:13px" valign="top">
										...
										<td width="10px"></td>
										<td><textarea name="taaddetails" id="taMessage2" style="width:350px;height:100px;font-family:tahoma;font-size:13px" onkeyup="CheckFieldLength(this, 'charcount2', 'remaining2', 1000);" onkeydown="CheckFieldLength(this, 'charcount2', 'remaining2', 1000);" onmouseout="CheckFieldLength(this, 'charcount2', 'remaining2', 1000);" onfocus="ChangeHeight('taarea2char')"></textarea></td>
									</tr>
									<tr style="font-family:tahoma;font-size:13px;" valign="top">
										<td align="right" width="200px"></td>
										<td width="10px"></td>
										<td><div id="taarea2char" style="height:0px;overflow:hidden"><small><span id="charcount2">0</span> characters entered. | <span id="remaining2">500</span> characters remaining.</small></div></td>
									</tr>
									...
									<tr style="font-family:tahoma;font-size:13px">
										...
										<td width="10px"></td>
										<td><input type="text" name="txtsize" style="width:150px;height:27px" maxlength="50" onKeyUp="numericFilter(this);FldTextValidation(this, 'sizeerrtxt')"> <span id="sizetext"></span></td>
									</tr>
									<tr style="font-family:tahoma;font-size:13px;color:red">
										<td colspan="2"></td>
										<td id="sizeerrtxt"></td>
									...
									<tr style="font-family:tahoma;font-size:13px">
										...
										<td width="10px"></td>
										<td><input type="text" name="txtprice" style="width:150px;height:27px" maxlength="50" onKeyUp="numericFilter(this);FldTextValidation(this, 'priceerrtxt')"></td>
									</tr>
									<tr style="font-family:tahoma;font-size:13px;color:red">
										<td colspan="2"></td>
									...
									<tr style="font-family:tahoma;font-size:13px">
										...
										<td width="10px"></td>
										<td><iframe style="width:100%;height:25px;" src="uploadform.php?adid=<?php echo $maxadid;?>" scrolling="no" frameborder="0"></iframe></td>
									</tr>
									<tr height="15px">
										<td colspan="3"></td>
									</tr>
									...
									<tr style="font-family:tahoma;font-size:13px">
										...
										<td width="10px"></td>
										<td><input type="text" name="txtname" style="width:250px;height:27px;" maxlength="30" onKeyUp="FldTextValidation(this, 'ynameerrtxt')"></td>
									</tr>
									<tr style="font-family:tahoma;font-size:13px;color:red">
										<td colspan="2"></td>
									...
									<tr style="font-family:tahoma;font-size:13px">
										...
										<td width="10px"></td>
										<td><input type="text" name="txtphone" style="width:200px;height:27px;" maxlength="30" onKeyUp="FldTextValidation(this, 'phoneerrtxt')"></td>
									</tr>
									<tr style="font-family:tahoma;font-size:13px;color:red">
										<td colspan="2"></td>
									...
									<tr style="font-family:tahoma;font-size:13px">
										...
										<td width="10px"></td>
										<td><input type="text" name="txtemail" style="width:250px;height:27px;" maxlength="40" onKeyUp="FldTextValidation(this, 'emailerrtxt')"></td>
									</tr>
									<tr style="font-family:tahoma;font-size:13px;color:red">
										<td colspan="2"></td>
